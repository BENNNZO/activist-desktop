    ...
    return (
        <div className='flex flex-col gap-2 items-center p-5'>
            <div className='shadow-md rounded-xl p-5 bg-white'>
                <div className='relative h-8 flex justify-center items-center'>
                    <AnimatePresence initial={false}>
                        {set ? 
                            <motion.h2 
                                key="Mood"
                                className='text-5xl leading-relaxed text-center font-bold text_gradient2 absolute'
                            ...
                            <motion.h2 
                                key="Energy"
                                className='text-5xl leading-relaxed text-center font-bold text_gradient3 absolute'
                                initial={{ opacity: 0, x: -10 }}
                                animate={{ opacity: 1, x: 0 }}
                                exit={{ opacity: 0, x: 10 }}
                                transition={{ duration: 0.1 }}
                ...
                <ResponsiveContainer height="85%" width={350}>
